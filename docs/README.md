...
- **[notes/realtime-midi-pipeline.md](notes/realtime-midi-pipeline.md)** - MIDI 管线实时注意事项（AllNotesOff/Killed、PitchBend 映射、rfd 崩溃等）

### 🏗️ 架构设计

- **[architecture/overview.md](architecture/overview.md)** - DAW 隔离、内部合成、预过滤架构
- **[architecture/modules.md](architecture/modules.md)** - lib/engine/data/utils/editor 模块划分
...
- **[knowledge/nih-plug-egui-integration.md](knowledge/nih-plug-egui-integration.md)** - egui UI 集成与文件选择器实现要点
...
- **[decisions/tick-based-event-storage.md](decisions/tick-based-event-storage.md)** - 为什么 MIDI 事件使用 `tick` 而非 `sample_offset`
- **[decisions/midi-loader-separation.md](decisions/midi-loader-separation.md)** - 为什么把 MIDI 解析与实时调度彻底分离
...
- [decisions/tick-based-event-storage.md](decisions/tick-based-event-storage.md)
- [decisions/midi-loader-separation.md](decisions/midi-loader-separation.md)
- [notes/realtime-midi-pipeline.md](notes/realtime-midi-pipeline.md)

### 阶段 5：Egui UI 与文件持久化 🟡
- [knowledge/nih-plug-egui-integration.md](knowledge/nih-plug-egui-integration.md) - egui + rfd 文件选择器实现
- [architecture/modules.md](architecture/modules.md) - `editor.rs` 模块职责
